...
public final class ProjectileSettingsScreen extends Screen {
    ...
    private void addToggleRow(int x, int contentY, String key, CameraLockOnConfig.BooleanValue value) {
        addToggleRow(x, contentY, 150, key, value);
    }

    private void addToggleRow(int x, int contentY, int width, String key, CameraLockOnConfig.BooleanValue value) {
