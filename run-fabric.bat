...
cls
echo ====================================================
echo        Camera Lock-On - Fabric Dev Client
echo ====================================================
echo   1) Fabric 1.21.11
echo   2) Fabric 1.21.4
echo   3) Fabric 1.21.1
echo   0) Exit
echo ----------------------------------------------------
...
:RUN_12111
set "TARGET_DIR=fabric-1.21.11"
goto :START_CLIENT

:RUN_1214
set "TARGET_DIR=fabric-1.21.4"
goto :START_CLIENT

:RUN_1211
set "TARGET_DIR=fabric-1.21.1"
goto :START_CLIENT
