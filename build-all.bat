...
@echo off
setlocal
powershell -NoProfile -ExecutionPolicy Bypass -Command "$Root = '%~dp0'; & ([scriptblock]::Create((Get-Content -LiteralPath '%~f0' -Raw)))"
...
$WorkspaceParent = Split-Path -Parent $Root.TrimEnd('\', '/')
